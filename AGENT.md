...
`GET /` · `POST /api/extract` · `GET|POST|DELETE /api/dirs` · `POST /api/download` · `GET /api/jobs` · `GET /api/history?dir&date` · `GET /api/base` · `POST /api/choose-dir` · `GET /api/cookies/status` · `POST /api/cookies/export`
